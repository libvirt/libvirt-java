...
public class TestJavaBindings extends TestCase {
	...
	public void testNodeInfo() throws Exception {
		...
		assertTrue("conn.getCellsFreeMemory",
				conn.getCellsFreeMemory(0, 10) > 0);
	...
	public void testNetworkCreate() throws Exception {
		...
		assertEquals("Number of defined networks", 1, conn
				.numOfDefinedNetworks());
		assertEquals("Number of listed defined networks", 1, conn
				.listDefinedNetworks().length);
		...
		this
				.validateNetworkData(conn
						.networkLookupByUUIDString("004b96e1-2d78-c30f-5aa5-f03c87d21e67"));
		this.validateNetworkData(conn.networkLookupByUUID(UUID
				.fromString("004b96e1-2d78-c30f-5aa5-f03c87d21e67")));
	...
	public void validateNetworkData(Network network) throws Exception {
		...
		assertEquals("network.getBridgeName()", "deftest", network
				.getBridgeName());
		assertEquals("network.getUUIDString()",
				"004b96e1-2d78-c30f-5aa5-f03c87d21e67", network.getUUIDString());
	...
	public void testDomainCreate() throws Exception {
		...
		Domain dom2 = conn.domainCreateLinux("<domain type='test' id='3'>"
				+ "  <name>createst</name>"
				+ "  <uuid>004b96e1-2d78-c30f-5aa5-f03c87d21e67</uuid>"
				+ "  <memory>8388608</memory>" + "  <vcpu>2</vcpu>"
				+ "  <os><type arch='i686'>hvm</type></os>"
		...
		assertEquals("Number of listed defined domains", 1, conn
				.listDefinedDomains().length);
		...
		this
				.validateDomainkData(conn
						.domainLookupByUUIDString("004b96e1-2d78-c30f-5aa5-f03c87d21e67"));
		this.validateDomainkData(conn.domainLookupByUUID(UUID
				.fromString("004b96e1-2d78-c30f-5aa5-f03c87d21e67")));
	}
	...
	public void validateDomainkData(Domain dom) throws Exception {
		...
		assertEquals("dom.getUUIDString()",
				"004b96e1-2d78-c30f-5aa5-f03c87d21e67", dom.getUUIDString());
	...
	public void testInterfaces() throws Exception {
		...
		assertEquals("virtInterfaceGetMACString", "aa:bb:cc:dd:ee:ff", virtInt
				.getMACString());
		assertNotNull("virtInterfaceGetXMLDesc", virtInt.getXMLDescription(0));
		System.out.println(virtInt.getXMLDescription(0));

		String newXML = "<interface type='ethernet' name='eth2'>"
				+ "<start mode='onboot'/>"
				+ "<mac address='aa:bb:cc:dd:ee:fa'/>" + "<mtu size='1492'/>"
				+ "<protocol family='ipv4'>"
				+ "<ip address='192.167.0.5' prefix='24'/>"
				+ "<route gateway='192.167.0.1'/>" + "</protocol>"
				+ "</interface>";
		...
		assertEquals("virtInterfaceGetMACString", "aa:bb:cc:dd:ee:fa", virtInt2
				.getMACString());
