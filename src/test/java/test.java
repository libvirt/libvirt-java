...
public class test {
	...
	public static void main(String[] args) {
		...
		// The array below is to support the uuid lookup based on an array of ints. 
		 ...
		 * Test Authentication
		 * 
		 * If you want to test authentication, uncomment the try catch block and one
		 * of the conn lines. You need to configure your libvirtd for remote/authenticated 
		 * connections before this will work.
		 */
		/*
		...
		try{
		    ...
		    conn = new Connect("qemu+tcp://localhost/system", defaultAuth, 0);		    
			conn = new Connect("test:///default", defaultAuth, 0);			
