...
JNIEXPORT jint JNICALL Java_org_libvirt_VirNetwork__1create
  (JNIEnv *env, jobject obj, jlong VNP){
	return virNetworkCreate((virNetworkPtr)VNP);
}

JNIEXPORT jint JNICALL Java_org_libvirt_VirNetwork__1destroy
(JNIEnv *env, jobject obj, jlong VNP){
	return virNetworkDestroy((virNetworkPtr)VNP);
}

JNIEXPORT jint JNICALL Java_org_libvirt_VirNetwork__1free
(JNIEnv *env, jobject obj, jlong VNP){
	return virNetworkFree((virNetworkPtr)VNP);
}

JNIEXPORT jboolean JNICALL Java_org_libvirt_VirNetwork__1getAutostart
  (JNIEnv *env, jobject obj, jlong VNP){
	int autostart;
...
JNIEXPORT jstring JNICALL Java_org_libvirt_VirNetwork__1getName
  (JNIEnv *env, jobject obj, jlong VNP){
	return (*env)->NewStringUTF(env, virNetworkGetName((virNetworkPtr)VNP));
}

JNIEXPORT jintArray JNICALL Java_org_libvirt_VirNetwork__1getUUID
  (JNIEnv *env, jobject obj, jlong VNP){
...
JNIEXPORT jstring JNICALL Java_org_libvirt_VirNetwork__1getUUIDString
(JNIEnv *env, jobject obj, jlong VNP){
...
JNIEXPORT jint JNICALL Java_org_libvirt_VirNetwork__1undefine
  (JNIEnv *env, jobject obj, jlong VNP){
