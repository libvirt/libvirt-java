...
public class VirDomain {
	...
	/**
	 * Constructs a VirDomain object from a known native virDomainPtr, and a VirConnect object.
	 ...
	 */
	VirDomain(VirConnect virConnect, long VDP){
	 ...
	 * 
	 * @return a VirDomainInfo object describing this domain
	 * @throws LibvirtException
	 */
	public VirDomainInfo getInfo() throws LibvirtException{
		return _getInfo(VDP);
	}
	
	private native VirDomainInfo _getInfo(long VDP) throws LibvirtException;
	 ...
	 * 
	 * @return an array of VirSchedParameter objects
	 * @throws LibvirtException
	 */
	public VirSchedParameter[] getSchedulerParameters() throws LibvirtException{
		return _getSchedulerParameters(VDP);
	}
	
	private native VirSchedParameter[] _getSchedulerParameters (long VDP) throws LibvirtException;
	
	/**
	 * Changes the scheduler parameters
	 * 
	 * @param params an array of VirSchedParameter objects to be changed
	 * @throws LibvirtException
	 */
	public void setSchedulerParameters(VirSchedParameter[] params) throws LibvirtException{
		_setSchedulerParameters(VDP, params);
	}
	
	private native int _setSchedulerParameters(long VDP, VirSchedParameter[] params) throws LibvirtException;
	 ...
	 * 
	 * @return an array of VirVcpuInfo object describing the VCPUs
	 * @throws LibvirtException
	 */
	public VirVcpuInfo[] getVcpusInfo() throws LibvirtException{
		return _getVcpusInfo(VDP);
	}
	
	private native VirVcpuInfo[] _getVcpusInfo(long VDP) throws LibvirtException;
	 ...
	 * Individual fields within the VirDomainBlockStats object may be returned as -1, which indicates that the hypervisor does not support that particular statistic.
	 * 
	 * @param path path to the block device
	 * @return the statistics in a VirDomainBlockStats object
	 * @throws LibvirtException
	 */
	public VirDomainBlockStats blockStats(String path) throws LibvirtException{
		return _blockStats(VDP, path);
	}
	
	private native VirDomainBlockStats _blockStats(long VDP, String path) throws LibvirtException;
	 ...
	 * To get stats for each you should make multiple calls to this function. 
	 * Individual fields within the VirDomainInterfaceStats object may be returned as -1, which indicates that the hypervisor does not support that particular statistic.
	 * 
	 * @param path path to the interface
	 * @return the statistics in a VirDomainInterfaceStats object
	 * @throws LibvirtException
	 */
	public VirDomainInterfaceStats interfaceStats(String path) throws LibvirtException{
		return _interfaceStats(VDP, path);
	}

	private native VirDomainInterfaceStats _interfaceStats(long VDP, String path) throws LibvirtException;
	 ...
	 * Flags may be one of more of the following: VirDomain.VIR_MIGRATE_LIVE Attempt a live migration. 
	 ...
	 * To see which features are supported by the current hypervisor, see VirConnect.getCapabilities, 
	 ...
	 * 
	 * @param dconn destination host (a VirConnect object)
	 * @param flags flags
	 ...
	 * @throws LibvirtException
	 */
	public VirDomain migrate(VirConnect dconn, long flags, String dname, String uri, long bandwidth) throws LibvirtException{
		return new VirDomain(dconn, _migrate(VDP, dconn, flags, dname, uri, bandwidth));
	}
	
	private native long _migrate(long VDP, VirConnect dconn, long flags, String dname, String uri, long bandwidth) throws LibvirtException;
	 ...
	 * Use VirDomain.resume() to reactivate the domain. This function requires priviledged access.
	 * 
	 * @throws LibvirtException
	 */
	 ...
	 * Use VirConnect.virDomainRestore() to restore a domain after saving.
	 * 
